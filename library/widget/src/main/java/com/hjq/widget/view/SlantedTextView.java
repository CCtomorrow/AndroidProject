...
public final class SlantedTextView extends View {
    ...
    public SlantedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SlantedTextView_android_textSize, (int) getResources().getDimension(com.hjq.base.R.dimen.sp_12)));
