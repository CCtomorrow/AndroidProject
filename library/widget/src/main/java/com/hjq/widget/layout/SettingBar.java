...
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLeftView.setLineSpacing(getResources().getDimension(com.hjq.base.R.dimen.dp_5), mLeftView.getLineSpacingMultiplier());
        mRightView.setLineSpacing(getResources().getDimension(com.hjq.base.R.dimen.dp_5), mRightView.getLineSpacingMultiplier());

        mLeftView.setPaddingRelative((int) getResources().getDimension(com.hjq.base.R.dimen.dp_15),
                (int) getResources().getDimension(com.hjq.base.R.dimen.dp_12),
                (int) getResources().getDimension(com.hjq.base.R.dimen.dp_15),
                (int) getResources().getDimension(com.hjq.base.R.dimen.dp_12));
        mRightView.setPaddingRelative((int) getResources().getDimension(com.hjq.base.R.dimen.dp_15),
                (int) getResources().getDimension(com.hjq.base.R.dimen.dp_12),
                (int) getResources().getDimension(com.hjq.base.R.dimen.dp_15),
                (int) getResources().getDimension(com.hjq.base.R.dimen.dp_12));
        ...
        setLeftDrawablePadding(array.hasValue(R.styleable.SettingBar_bar_leftDrawablePadding) ?
                ...
                (int) getResources().getDimension(com.hjq.base.R.dimen.dp_10));
        ...
        // 文字颜色设置
        setLeftTextColor(array.getColor(R.styleable.SettingBar_bar_leftTextColor, ContextCompat.getColor(getContext(), com.hjq.base.R.color.black80)));
        setRightTextColor(array.getColor(R.styleable.SettingBar_bar_rightTextColor, ContextCompat.getColor(getContext(), com.hjq.base.R.color.black60)));

        // 文字大小设置
        setLeftTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_leftTextSize, (int) getResources().getDimension(com.hjq.base.R.dimen.sp_15)));
        setRightTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_rightTextSize, (int) getResources().getDimension(com.hjq.base.R.dimen.sp_14)));
